...
public class FlightSceneBrasov {
    private Group root ;
    ...
    private void ShowFlight(Flight flightCurrent,Integer xValue,Integer yValue,StackPane unite)
    {
        ...
        background.setText(background.getText()+"    "+flightCurrent.getM_id_destinationFrom().getCity());
    ...
    private StackPane flightDetails(Flight currentFlight)
    {
        ...
        submit.setOnAction(t -> {
            ...
            if(currentFlight.getM_id_plane().getM_nr_seats()==0)
            {
                error.setContentText("Nu mai sunt Bilete disponibile!");
                error.show();
                return;
            }
    ...
    private void background()
    {
        ...
        Label title = new Label("Zborurile care vor ajunge la aeroport");
        title.setId("Title");
        title.setPadding(new Insets(0,0,0,50));
        title.setTranslateX(width/2-285);
    ...
    public Scene start(Scene lastScene)
    {
        ...
        ReadDB read = new ReadDB();
            ...
            List = read.readFlightsLeaveHome();
